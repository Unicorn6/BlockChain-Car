...
contractInstance=VotingContract.at('0xca4ea50dbe191fab51622cc1f74c3d26a93d8c98');
var myid;
...
function transaction()
{
  carreg=$("#carid").val();
  adr=$("#userid").val();
  if((contractInstance.validate_owner.call(myid,carreg,{from: web3.eth.accounts[0]}))&&(contractInstance.validate_user.call(adr,{from: web3.eth.accounts[0]})))
  { var iddd=contractInstance.find_user_id.call(adr,{from: web3.eth.accounts[0]}).toString();
    user=parseInt(iddd);
